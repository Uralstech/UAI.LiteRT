...
#nullable enable
namespace Uralstech.UAI.LiteRTLM.Omni.Editor
{
    internal sealed class IOSBuildPostProcessor : IPostprocessBuildWithReport
    {
        private const string DeviceLibPath = "$(PROJECT_DIR)/Libraries/ARM64/Packages/com.uralstech.uai.litertlm.omni/Runtime/Plugins/iOS/arm64";
        private const string SimLibPath = "$(PROJECT_DIR)/Libraries/ARM64Simulator/Packages/com.uralstech.uai.litertlm.omni/Runtime/Plugins/iOS/sim_arm64";
        
        private const string SwiftDeviceLibPath = "$(PROJECT_DIR)/UnityFramework/Libraries/ARM64/Packages/com.uralstech.uai.litertlm.omni/Runtime/Plugins/iOS/arm64";
        private const string SwiftSimLibPath = "$(PROJECT_DIR)/UnityFramework/Libraries/ARM64Simulator/Packages/com.uralstech.uai.litertlm.omni/Runtime/Plugins/iOS/sim_arm64";
