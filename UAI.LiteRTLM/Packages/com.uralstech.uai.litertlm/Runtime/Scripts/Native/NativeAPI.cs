...
namespace Uralstech.UAI.LiteRTLM.Native
{
    public static class NativeAPI
    {
        ...
        public static class EngineSettings
        {
            ...
            /// <returns>A pointer to the created settings, or <see cref="IntPtr.Zero"/> on failure.</returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr litert_lm_engine_settings_create_from_raw_file_descriptor(int fd,
                [MarshalAs(UnmanagedType.LPUTF8Str)] string backendStr,
                [MarshalAs(UnmanagedType.LPUTF8Str)] string? visionBackendStr,
                [MarshalAs(UnmanagedType.LPUTF8Str)] string? audioBackendStr);
            ...
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern void litert_lm_engine_settings_set_litert_dispatch_lib_dir(IntPtr settings,
            ...
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern void litert_lm_engine_settings_set_num_prefill_tokens(IntPtr settings,
            ...
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern void litert_lm_engine_settings_set_num_decode_tokens(IntPtr settings,
                int numDecodeTokens);
            ...
            /// <returns>0 on success, non-zero on failure.</returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern int litert_lm_engine_settings_set_supported_lora_ranks(IntPtr settings,
        ...
        public static class Session
        {
            ...
            /// </returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr litert_lm_session_generate_content(IntPtr session, IntPtr[] inputs,
                UIntPtr numInputs);
            ...
            /// <returns>0 on success, non-zero on failure.</returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern int litert_lm_session_run_decode_async(IntPtr session, IntPtr callback,
                IntPtr callbackData);
            ...
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern int litert_lm_session_generate_content_stream(IntPtr session, IntPtr[] inputs,
                UIntPtr numInputs, IntPtr callback, IntPtr callbackData);
        }
        ...
        public static class Responses
        {
            ...
            /// <returns>
            /// The response text. The returned string is owned by the Responses
            /// object and is valid only for its lifetime. Returns <see cref="IntPtr.Zero"/> if index is out of bounds.
            /// </returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr litert_lm_responses_get_response_text_at(IntPtr responses, int index);
        ...
        public static class BenchmarkInfo
        {
            ...
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern int litert_lm_benchmark_info_get_prefill_token_count_at(IntPtr benchmarkInfo,
                int index);
            ...
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern double litert_lm_benchmark_info_get_prefill_tokens_per_sec_at(IntPtr benchmarkInfo,
                int index);
        ...
        public static class Conversation
        {
            ...
            /// </returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr litert_lm_conversation_send_message(IntPtr conversation,
                [MarshalAs(UnmanagedType.LPUTF8Str)] string messageJson,
                [MarshalAs(UnmanagedType.LPUTF8Str)] string? extraContext, IntPtr optionalArgs);
            ...
            /// </returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr litert_lm_conversation_render_preface_to_string(IntPtr conversation);
        ...
        public static class JsonResponse
        {
            ...
            /// <returns>
            /// The response JSON string. The returned string is owned by the
            /// JsonResponse object and is valid only for its lifetime. Returns
            /// <see cref="IntPtr.Zero"/> if <paramref name="response"/> is <see cref="IntPtr.Zero"/>.
            /// </returns>
            [DllImport(LibLiteRTLM, CallingConvention = CallingConvention.Cdecl)]
